                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('produk.update', $produk->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Gambar</label>
                                            <img src="{{ asset('/images/produk/' . $produk->gambar_produk) }}" width="100">
                                            <input type="file" class="form-control" name="gambar_produk" accept="image/*" value="{{ $produk->gambar_produk }}" required>
                                        </div><br>
                                        <div class="form-group">
                                            <label>Id Kategori</label>
                                            <select name="id_kategori" class="form-control" required>
                                                <option header>Pilih Kategori</option>
