            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <a href="{{ route('produk.create') }}" class="btn btn-primary"><i class="bi bi-clipboard2-plus"></i> Tambah Data</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('/images/produk/' . $data->gambar_produk) }}" alt="" width="100">
                                    </td>
